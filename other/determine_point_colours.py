...
colour_lookup = pd.read_excel(r"/home/harryc/github/DeMBA_scripts/data_files/CustomRegionMouse_2017.xlsx")
colour_lookup = colour_lookup.rename(columns=new_names)

arr = nib.load('/home/harryc/github/CCF_translator_local/demo_data/demba_20um/P56_annotation_20um.nii.gz').get_fdata()
df = pd.read_excel(r"/home/harryc/github/DeMBA_scripts/data_files/DeMBA_landmarksValidation_Ingvild.xlsx")


region_graph_colour = {
    i:j for i,j in zip(df['Acronym'].values , arr[
