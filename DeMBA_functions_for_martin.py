...
# test_path og lmrPoints må endres for hver transformasjon

test_path = r"C:\Users\ingvieb\Elastix_testing\P28\test_folder_name\\" #fyll inn den test folder path. i denne må LMR txt fil ligge. NB! Path må avsluttes med to \\, som i eksempelet her
    
lmrPoints = test_path + "my_lmr_file.txt" #fyll inn navn på LMR txt fil mellom ""


# disse holdes konstant, untatt når du skal gå over til neste transformasjon (P28->P21)
...
# disse holdes alltid konstant

resultTemplateName = test_path + "resultTemplate.nii"
resultSegmentationName = test_path + "resultSegmentation.nii"

LMRtoElastixPoints(lmrPoints, fixedAge, movingAge)

fixedPoints = test_path + fixedAge + "_points.pts"
movingPoints = test_path + movingAge + "_points.pts"
